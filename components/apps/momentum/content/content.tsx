...
const Content: React.FC = () => {
  return (
    <div className="lg:w-full text-center lg:text-left">
      <h1 className="text-4xl md:text-5xl font-bold text-gray-600 mb-6">Momentum TaskMaster</h1>
      ...
      <ul className="list-disc list-inside mb-6 space-y-2 text-left mx-auto lg:mx-0 max-w-md">
